...
Git 更适合管理 Markdown 文档、文案、大纲和素材说明。对于 `.pptx` 这类二进制文件，Git 虽然可以保存版本，但不容易展示每一页具体改了什么，也不适合多人同时编辑同一个文件。

因此，在小组 PPT 协作中，可以先用 Markdown 管理大纲、分工、讲稿和素材清单，等内容稳定后再整理成最终 PPT。
